...
(defsc BeanListItem [this {:bean/keys [name]}]
...
(defsc BeanForm [this {:bean/keys [id name]}]
  ...
  (dom/form {:onSubmit (fn [e]
            ...
            (dom/input {:value name :onChange #(m/set-string! this :bean/name :event %)})
